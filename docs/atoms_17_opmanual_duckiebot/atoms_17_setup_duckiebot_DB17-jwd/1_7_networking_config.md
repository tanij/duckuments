# Networking, a.k.a. the hardest part {#sec:duckiebot_network status=ready}
...
Note: this page is users operating with the "two-network" configuration, `DB17-w`. For a one adapter setup you will can skip directly to [](#duckiebot-internet-access), but you will have to connect to a network that you can ssh through.
