...
TODO for Jacopo: fix images, formatting
...
Both workarounds have their drawbacks, so it would be prefreable to find a robust solution for laptops connecting to the mesh network.
