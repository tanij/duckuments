...
TODO for Jacopo Tani: fix math and put it in latex environment, link video properly, link operation manual properly, format everything
...
f(r) = 1 + k<sub>1</sub>r + k<sub>2</sub>r<sup>2</sup> + ... + k<sub>n</sub>r<sup>n</sup>
...
<center><img figure-caption="Path from entrance to space 2" src="path_0_4.png" style="width: 500px;"/></center>
